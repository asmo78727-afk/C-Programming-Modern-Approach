...
int main(void) {
	...
	*/
	...
	scanf_s("%1d%1d%1d%1d%1d%1d%1d%1d%1d%1d%1d%1d", &d, &i1, &i2, &i3, &i4, &i5, &j1, &j2, &j3, &j4, &j5, &j6);
	...
	second_sum = d + i2 + i4 + j1 + j3 + j5; // 8+9+4+4+6+0 = 31
	first_sum = i1 + i3 + i5 + j2 + j4 + j6;//6+1+8+2+0+0 = 17
