	...
	int main(void)
	{
		...
		*/
		int gs1, country_of_origin, publisher_code_identifies, item_number, check_digit;
		printf("Enter ISBN: ");
		scanf_s("%d - %d - %d - %d - %d", &gs1, &country_of_origin, &publisher_code_identifies, &item_number, &check_digit);
	
		printf("GS1 prefix: %d\n",gs1);
		printf("Group identifier: %d\n", country_of_origin);
		printf("Publisher code: %d\n", publisher_code_identifies);
